...
@run_async
def colong(bot: Bot, update: Update, args: List[str]):
    msg = update.effective_message
    ...
    if msg.reply_to_message:
        if msg.reply_to_message.sticker:
            ...
            msg.reply_text("Yea, I can't colong that.")
        ...
        try:
            ...
            msg.reply_text("I can only colong images, dude.")
            print(e)
            return
        except TelegramError as e:
            if e.message == "Stickerset_invalid":
        ...
        packs = "Please reply to a sticker or image to colong it to your pack!\nOh by the way, here are your packs:\n"
        if packnum > 0:
...
- /colong: reply to a sticker or image to add it to your pack.
"""

__mod_name__ = "Stickers"
STICKERID_HANDLER = DisableAbleCommandHandler("stickerid", stickerid)
GETSTICKER_HANDLER = DisableAbleCommandHandler("getsticker", getsticker)
COLONG_HANDLER = DisableAbleCommandHandler("colong", colong, pass_args=True, admin_ok=False)

dispatcher.add_handler(STICKERID_HANDLER)
dispatcher.add_handler(GETSTICKER_HANDLER)
dispatcher.add_handler(COLONG_HANDLER)
